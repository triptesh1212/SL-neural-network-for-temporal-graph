...
from utils.memory_module import MemoryLP
from utils.graph import NeighborFinder
from utils import EarlyStopMonitor2, NegativeEdgeSampler

parser = argparse.ArgumentParser('DyRep experiments on temporal link prediction')
...
parser.add_argument('--n_layer', type=int, default=1, help='number of temporal graph attention layers')
parser.add_argument('--lr', type=float, default=0.0001, help='learning rate')
parser.add_argument('--drop_out', type=float, default=0.1, help='dropout probability')
parser.add_argument('--gpu', type=int, default=0, help='idx for the gpu to use')
parser.add_argument('--uniform', action='store_true', help='uniform temporal neighbor sampling (default: recent)')
...
logger.info('DyRep model saved to {}'.format(MODEL_SAVE_PATH))
