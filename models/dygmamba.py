...
parser.add_argument('--n_degree', type=int, default=20, help='kept for TGAT CLI compatibility (unused by DyGMamba)')
...
parser.add_argument('--n_layer', type=int, default=2, help='number of Mamba layers')
parser.add_argument('--lr', type=float, default=0.0001, help='learning rate')
parser.add_argument('--drop_out', type=float, default=0.1, help='dropout probability')
parser.add_argument('--gpu', type=int, default=0, help='idx for the gpu to use')
parser.add_argument('--uniform', action='store_true', help='uniform temporal neighbor sampling in NeighborFinder')
...
parser.add_argument('--gamma', type=float, default=0.5, help='DyGMamba gamma for time-diff branch')
parser.add_argument('--max_input_sequence_length', type=int, default=64, help='max neighbor sequence length')
parser.add_argument('--max_interaction_times', type=int, default=10, help='max prior src-dst interactions')
...
logger.info('DyGMamba model saved to {}'.format(MODEL_SAVE_PATH))
