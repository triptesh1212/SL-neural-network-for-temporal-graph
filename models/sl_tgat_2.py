...
from utils.sl_module import SLTGANNeighborDiff
from utils.graph import NeighborFinder
from utils import EarlyStopMonitor, RandEdgeSampler

parser = argparse.ArgumentParser('SL-TGAT neighbor-diff experiments on temporal link prediction')
...
parser.add_argument('--dt', type=float, default=1.0, help='SL integration time step')
...
tag = f'sl-tgat-nd-{args.attn_mode}'
...
logger.info('SL-TGAT neighbor-diff model saved to {}'.format(MODEL_SAVE_PATH))
